...
public class RemoveLinkedList_Ower {
    /*
  ...
  Constraints:
    ...
    public static void main(String[] args) {
        ...
        RemoveLinkedList_Ower solution = new RemoveLinkedList_Ower();
    ...
    // time complexity : O(n) space complexity : O(1)
    public ListNode withOnlyOnePointer(ListNode head, int val) {
